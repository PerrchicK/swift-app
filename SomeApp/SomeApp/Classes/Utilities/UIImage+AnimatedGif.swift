...
//  Reference: https://github.com/bahlo/SwiftGif/tree/master/SwiftGifCommon
...
extension UIImage {
    ...
    public class func gifWithData(_ data: Data, frameRate: TimeInterval = 1000.0) -> UIImage? {
    ...
    public class func gifWithName(_ name: String, frameRate: TimeInterval = 1000.0) -> UIImage? {
    ...
    class func animatedImageWithSource(_ source: CGImageSource, frameRate: TimeInterval = 1000.0) -> UIImage? {
